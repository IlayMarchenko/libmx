...
int main(int argc, char const *argv[]) {
    ...
    bool in_loop = true;
    char array[54][30] = {"mx_printchar.c", "mx_print_unicode.c", "mx_printstr.c", "mx_print_strarr.c", "mx_printint.c", "mx_pow.c", "mx_sqrt.c",
        ...
        "mx_list_size.c", "mx_memmove.c", "mx_push_back.c", "mx_pop_front.c", "mx_pop_back.c", "mx_sort_list.c"};
